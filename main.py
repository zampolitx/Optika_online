...
def index():
    ...
    print(xxx[3][1])
    print(xxx)
    parlor1={'Здание 1': [{'100': [{'Панель 1': ['Кросс 1', 'Кросс 2']}, {'Панель 2': ['Кросс 3', 'Кросс 4']}]}, {'101': ['Панель 3', 'Панель 4']}, {'102': ['Панель 5', 'Панель 6']}]}  # Список строк из базы данных (вторая строка)
