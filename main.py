...
def index():
    ...
    parlor1={'Здание 1':
                 [{'100':
                       [{'Панель 1':
                             [{'Кросс 1':
                                   [{'ОК1': ['Волокно1', 'Волокно2', 'Волокно3']},
                                    {'ОК2': ['Волокно1', 'Волокно2']},
                                    {'ОК2': ['Волокно1', 'Волокно2']},
                                    {'ОК2': ['Волокно1', 'Волокно2']},
                                    {'ОК2': ['Волокно1', 'Волокно2']},
                                    {'ОК2': ['Волокно1', 'Волокно2']},
                                    {'ОК3': ['Волокно1', 'Волокно2', 'Волокно3']}]},
                              {'Кросс 2':
                                   [{'ОК9': ['Волокно1', 'Волокно2', 'Волокно3']},
                                    {'ОК10': ['Волокно1', 'Волокно2', 'Волокно3']}]}]},
                        {'Панель 2':
                             [{'Кросс 3':
                                   [{'ОК4': ['Волокно1']}]},
                              {'Кросс 4':
                                   [{'ОК6': ['Волокно1']},
                                    {'ОК7': ['Волокно1']}]}]}]}],  # Список строк из базы данных (вторая строка)
